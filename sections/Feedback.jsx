    ...
    >
      ...
      >
        ...
        <div>
          ...
          <p className="mt-[8px] font-medium sm:text-[18px]
        ...
        <p className="mt-[24px] font-normal sm:text-[24px]
          ...
          "This is the future of connection, 
          a digital canvas where human ingenuity paints the next chapter. Imagine a space where ideas 
          materialize instantly, and limitless possibilities converge. 
          "
        </p>
      </motion.div>
