    ...
    >
      ...
      <TitleText title={(
        <>
          ...
          invite them to play together in the same world
        </>
        ...
        <motion.div
          ...
          right-20 w-[70px] h-[70px] p-[6px]
          rounded-full bg-[#e7700e]">
            <img 
          ...
          left-[45%] w-[70px] h-[70px] p-[6px]
          rounded-full bg-[#485bc1]">
            <img 
